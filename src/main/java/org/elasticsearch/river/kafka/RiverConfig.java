...
public class RiverConfig {
    ...
    private String dynamicIndexField;


    private String typeName;
    private boolean isDynamicType = false;
    ...
    public RiverConfig(RiverName riverName, RiverSettings riverSettings) {
        ...
        if (riverSettings.settings().containsKey("index")) {
            ...
            dynamicIndexField = dynamicIndex();
            isDynamicIndex = !indexName.equals(dynamicIndexField);
            typeName = XContentMapValues.nodeStringValue(indexSettings.get(MAPPING_TYPE), "status");
            dynamicTypeField = dynamicType();
            isDynamicType = !typeName.equals(dynamicTypeField);
    ...
    public String getDynamicIndexField() {
        return dynamicIndexField;
    }
    ...
    public String getDynamicTypeField() {
